...
public class Cache {
    ...
    protected ArrayList<LIRS_RDFILE_OBJECT.Block_Func> Block_recency = new ArrayList<>();
    protected Queue<LIRS_RDFILE_OBJECT.Block_Func> Block_residentHIR = new LinkedList<>();
    protected Queue<LIRS_RDFILE_OBJECT.Block_Func> Block_LIR = new LinkedList<>();
    protected Block_Func [] Qarray = null;
