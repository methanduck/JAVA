...
public class Cache {
    ...
    protected ArrayList<LIRS_RDFILE.Block_Func> Block_recency = new ArrayList<>();
    protected Queue<LIRS_RDFILE.Block_Func> Block_residentHIR = new LinkedList<>();
    protected Queue<LIRS_RDFILE.Block_Func> Block_LIR = new LinkedList<>();
